            ...
            <div class="row">
                <div class="col-lg-4">
                    ...
                    <div class="small-box bg-info">
                        ...
                        <a href="/dataguru" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
                    </div>
                </div>
                <!-- ./col -->
                <div class="col-lg-4">
                ...
                <div class="col-lg-4">
                    ...
                    <div class="small-box bg-danger
                        ...
                        <a href="/datauser" class="small-box-footer text-white" style="color: white;">More info <i class="fas fa-arrow-circle-right text-white"></i></a>
                    </div>
                </div>
