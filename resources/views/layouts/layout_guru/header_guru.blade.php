...
<head>
  ...
  <title>Sistem Monitoring Perkembangan Anak</title>
  ...
  <link rel="stylesheet" href="{{asset('adminlte-v3')}}/plugins/datatables-responsive/css/responsive.bootstrap4.min.css">
