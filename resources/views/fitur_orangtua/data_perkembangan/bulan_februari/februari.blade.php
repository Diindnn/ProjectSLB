                    ...
                    <div class="col-sm-6">
                        <h3>
                            <a href="{{ url()->previous() }}" class="text-dark" style="font-size: 17px;">
                                <i class="fas fa-arrow-left" style="padding-right: 15px;"></i></a>Semester Genap
                        </h3>
                    </div>
                    <div class="col-sm-6">
                                ...
                                <div class="container">
                                    <div class="row">
                                        <div class="col text-center">
                                            <h4>Data Perkembangan Bulan Februari</h4>
                                            <!-- Form filter -->
                                ...
                                <table id="example1" class="table table-bordered table-striped">
                                    ...
                                    <tbody style="text-align: center">
                                        <tr>
                                            ...
                                            <td>5</td>
                                            <td>
                                                <a href="{{ route('laporan_februari') }}" class="btn btn-success btn-sm">
