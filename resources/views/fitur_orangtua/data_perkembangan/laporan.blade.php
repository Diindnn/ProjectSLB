                    ...
                    <div class=card>
                        <div class="card-body" style="padding: 10px">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mt-4">
                                    <a href="{{ url('orangtua/dataperkembangan/' . request()->segment(3) . '/laporan-pdf') }}?siswa={{$siswa->id}}&minggu={{$minggu}}&tahun={{$tahun}}" class="btn btn-info float-right btn-cetak-pdf mr-3" id="btnCetakPDF">
