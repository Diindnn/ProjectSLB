...
<style>
    ...
    .profile-box {
        ...
        width: 100%;
        height: auto;
        border: 1px solid #ccc; /* Menambah border */
        display: flex;
    ...
    .custom-file-labels {
        display: none; /* Sembunyikan tulisan "Pilih File" */
    }
    ...
    .file-labels {
        ...
        cursor: pointer; /* Pointer ketika di hover */
        font-size: 10px; /* Mengatur ukuran font */
        border: 1px solid #222222; /* Menambahkan border pada teks */
        margin-top: 3px;
