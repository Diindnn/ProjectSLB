                                            ...
                                            <div class="form-group mt-1" style="padding-left: 30%;">
                                                <label for="exampleInputFile" class="profile-box">
                                                    <div class="logo-container">
                                                        <img src="{{ asset('images') }}/fotoguru.jpg" class="image" alt="SLB Insan Prima bestari" style="max-width: 100%; height: auto;">
                                                    </div>
                                                </label>
                                                <!-- Tombol untuk update foto -->
                                                <input type="file" id="exampleInputFile" class="form-control-file" style="display: none;">
