...
<style>
    ...
    /* Gaya tombol "Simpan" saat dihover */
    .btn-simpan:hover {
                ...
                <div class="col-sm-6">
                    <h1>
                        <a href="{{ url()->previous() }}" class="text-dark" style="font-size: 17px;">
                            <i class="fas fa-arrow-left" style="padding-right: 15px;"></i></a>Edit Data Siswa
                    </h1>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-primary">
                        ...
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form role="form" id="addTeacherForm" action="{{url('updatedatasiswa', $data->id)}}" method="post" enctype="multipart/form-data">
                            @csrf
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <div class="form-group mt-1" style="padding-left: 30%;">
                                            ...
                                            <span class="text-danger">
                                                file foto harus bertipe jpg, jpeg atau png.
                                            </span>
                                        @endif
                                    ...
                                    <div class="col-md-9"> <!-- Kolom untuk input email address dan password -->
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-12 mt-3">
                                                <label>NISN :</label>
                                                <input type="number" class="form-control" name="nisn" value="{{$data->nisn}}" required>
                                                @error('nisn')
                                            ...
                                            <div class="col-md-12 mt-3"> <!-- Kolom untuk input password -->
                                                <label>Kelas :</label>
                                                <input type="number" class="form-control" name="kelas" value="{{$data->kelas}}" required>
                                            </div>
                                            <div class="col-md-12 mt-3">
                                                <label>Jenis Kebutuhan:</label>
                                                <input type="text" class="form-control" name="jenis_kebutuhan" value="{{$data->jenis_kebutuhan}}" required>
                                            </div>
                                            <div class="col-md-12 mt-3">
                                                <label>Alamat :</label>
                                            ...
                                            <div class="col-md-12 mt-3">
                                                ...
                                                <input type="text" class="form-control" name="nama_orangtua" value="{{$data->nama_orangtua}}" required>
                                            </div>
                                            <div class="col-md-12 mt-3">
                                                <label>Wali Murid:</label>
                                                <input type="text" class="form-control" name="wali_murid" value="{{$data->wali_murid}}" required>
                                            </div>
                                        </div>
                                    </div>
                                </div>
