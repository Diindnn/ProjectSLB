                ...
                <div class="col-sm-6">
                    <h1>
                        <a href="{{ url()->previous() }}" class="text-dark" style="font-size: 17px;">
                            <i class="fas fa-arrow-left" style="padding-right: 15px;"></i></a>Detail Data Guru
                    </h1>
                </div>
                    ...
                    <div class="card card-primary">
                        ...
                        <form role="form" id="addTeacherForm">
                                    ...
                                    <div class="col-md-9"> <!-- Kolom untuk input email address dan password -->
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-12 mt-3"> <!-- Kolom untuk input password -->
                                                <label>NUPTK </label>
                                                <input type="text" class="form-control" name="nuptk" value="{{$data->nuptk}}" readonly>
                                            </div>
                                            <div class="col-md-12 mt-3"> <!-- Kolom untuk input password -->
                                            ...
                                            <div class="col-md-12 mt-3"> <!-- Kolom untuk input password -->
                                                ...
                                                <input type="text" class="form-control" name="pendidikan" value="{{$data->pendidikan}}" readonly>
                                            </div>
                                            <div class="col-md-12 mt-3"> <!-- Kolom untuk input password -->
                                                <label>Alamat </label>
                                            ...
                                            <div class="col-md-12 mt-3"> <!-- Kolom untuk input password -->
                                                <label>No.Hp </label>
                                                <input type="text" class="form-control" name="nohp" value="{{$data->nohp}}" readonly>
                                            </div>
                                            <div class="col-md-12 mt-3"> <!-- Kolom untuk input password -->
                                                <label>Mengajar Kelas </label>
                                                <input type="text" class="form-control" name="kelas" value="{{$data->kelas}}" readonly>
                                                <input type="text" class="form-control" name="kelass" value="{{$data->kelass ?? '-'}}  " placeholder="Kelas ke 2 (opsional)" readonly>
                                                <input type="text" class="form-control" name="kelasss" value="{{$data->kelasss ?? '-'}}" placeholder="Kelas ke 3 (opsional)" readonly>
                                                <input type="text" class="form-control" name="kelassss" value="{{$data->kelassss ?? '-'}} " placeholder="Kelas ke 4 (opsional)" readonly>
                                            </div>
                                            <div class="col-md-12 mt-3"> <!-- Kolom untuk input password -->
                                                <label>Email </label>
                            ...
                            <div class="card-footer text-right" style="padding-right: 25px;">
                                <a href="{{ url('editguru', $data->id) }}" class="btn btn-edit-data">Edit Data</a>
                            </div>
