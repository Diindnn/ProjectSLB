...
<style>
    ...
    .btn-primary{
    background-color: #315E77; /* Ganti dengan kode warna yang diinginkan */
    border-color: #315E77; /* Ganti dengan kode warna yang sama dengan background-color atau warna yang sesuai */
    color: #fff; /* Warna teks pada tombol */
}

/* Efek hover */
.btn-primary:hover {
    background-color:#275067; /* Warna yang diinginkan saat tombol dihover */
    border-color: #275067; /* Warna border saat tombol dihover */
}
</style>
...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Grafik Semester {{ucwords(request()->segment(2))}}</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="#">Home</a></li>
                        <li class="breadcrumb-item active">Grafik Semester {{ucwords(request()->segment(2))}}</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
                            ...
                            <div class="container">
                                <div class="row">
                                    <div class="col text-center">
                                        ...
                                        <h5><b>PERIODE {{request()->segment(2) == 'ganjil' ? 'JULI - DESEMBER' : 'JANUARI - JUNI'}}</b></h5>
                                    </div>
                                </div>
                                <!-- Form filter -->
                                <form class="form-horizontal" action="{{url('grafikperkembangan', request()->segment(2))}}" method="get">
                                    <div class="form-group row mt-5">
                                        <label class="col-md-2 col-form-label">Pilih Siswa</label>
                                        <div class="col-md-4">
                                            <select name="idSiswa" class="form-control">
                                                @foreach($siswa as $s)
                                                <option value="{{$s->id}}" {{$s->id == $idSiswa ? 'selected': ''}}>{{$s->nama}} (Kelas {{$s->kelas}})</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="card card-info mt-5">
                                ...
                                <div class="card-body mt-3">
                                    <canvas id="{{ Illuminate\Support\Str::slug($aspek) }}" style="min-height: 250px; height: 250px; max-height: 250px; max-width: 100%;"></canvas>
                                </div>
        ...
        $(function () {
            ...
            var lineChart = new Chart(lineChartCanvas, {
                ...
                data: {
                    ...
                    datasets: [{
                        label: '{{ $aspek }}',
                        borderColor: 'rgba(65,141,188,0.8)',
                        pointRadius: 5,
                        pointColor: '#3b8bba',
