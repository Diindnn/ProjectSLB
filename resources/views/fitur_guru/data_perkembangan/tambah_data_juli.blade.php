                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group mt-2">
                                        <label for="exampleInputEmail1">1. Kemampuan Menulis</label>
                                            ...
                                            <input type="email" class="form-control mt-1" id="exampleInputEmail1"
                                            placeholder="Input Keterangan / Catatan">
                                    </div>

                                    <div class="form-group mt-4">
                                        <label for="exampleInputEmail1">2. Kemampuan Menulis</label>
                                            <form class="form-horizontal">
                                    ...
                                    <div class="form-group mt-4">
                                        <label for="exampleInputEmail1">3. Kemampuan Menulis</label>
                                            <form class="form-horizontal">
                                                <div class="form-group row mt-2">
                                                    <div class="col-md-12">
                                                        <select id="inputSkala" class="form-control">
